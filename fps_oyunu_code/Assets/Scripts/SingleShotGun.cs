...
public class SingleShotGun : Gun
{
    ...
    [Header("Recoil")]
    [SerializeField] private float maxRecoil = 2f; // Maksimum geri tepme miktarı
    [SerializeField] private float recoilSpeed = 5f; // Geri tepme hızı
